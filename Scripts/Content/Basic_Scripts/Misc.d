...
func int min(var int i, var int j) {
	if (i < j) {
		return i;
	};
	return j;
...
func int min3(var int i1, var int i2, var int i3) {
	return min(min(i1, i2), i3);
};

func int min4(var int i1, var int i2, var int i3, var int i4) {
	return min(min3(i1, i2, i3), i4);
};

func int min5(var int i1, var int i2, var int i3, var int i4, var int i5) {
	return min(min4(i1, i2, i3, i4), i5);
};

func int min6(var int i1, var int i2, var int i3, var int i4, var int i5, var int i6) {
	return min(min5(i1, i2, i3, i4, i5), i6);
};
